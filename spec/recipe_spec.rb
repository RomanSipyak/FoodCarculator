...
describe Recipe do
  before do
    ...
    let(:recipe) { described_class.new({ name: 'borsch', serving_count: 5 }, @arr) }

  describe '#total_cost' do
    context ' total cost of recipe' do
      it ('return total cost vhew values is correct') { expect(recipe.total_cost).to eq(15) }
      it ('return total cost vhew values is correct') do
